...
class MyMNISTTrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        hot_pos_tensor = torch.zeros_like(img_tensor)
        # Set the value at the index to 1
        hot_pos_tensor.view(-1)[pixel_index] = 1.0
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        batched_input = torch.empty((0, 12, 28, 28))
        ...
        for i in range(10):
            ...
            hot_pos_tensor = torch.zeros((1, 28, 28))
            hot_pos_tensor[0, 0, 0] = 1.0
        ...
        for i in range(0, 28*28):
            ...
            batched_input[:, 1].view(10, -1)[:, i] = 0.0
            try:
                batched_input[:, 1].view(10, -1)[:, i+1] = 1.0
            except IndexError:
                pass
